...
DEFINE_BLITTER(BlitTransLucent25AlphaZRead)
{
public:
	inline explicit BlitTransLucent25AlphaZRead(T* data, WORD mask, int shadecount) noexcept
	{
		PaletteData = data;
		Mask = mask;
	...
	virtual ~BlitTransLucent25AlphaZRead() override final = default;
