...
DEFINE_BLITTER(BlitTransLucent75AlphaZReadWrite)
{
public:
	inline explicit BlitTransLucent75AlphaZReadWrite(T* data, WORD mask, int shadecount) noexcept
	{
		PaletteData = data;
		Mask = mask;
	...
	virtual ~BlitTransLucent75AlphaZReadWrite() override final = default;
