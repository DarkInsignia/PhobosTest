...
DEFINE_RLE_BLITTER(RLEBlitTransLucent50ZRead)
{
public:
	inline explicit RLEBlitTransLucent50ZRead(T* data, WORD mask) noexcept
	{
		PaletteData = data;
		Mask = mask;
	}

	virtual ~RLEBlitTransLucent50ZRead() override final = default;
