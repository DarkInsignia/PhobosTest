...
DEFINE_RLE_BLITTER(RLEBlitTransLucent25ZReadWrite)
{
public:
	inline explicit RLEBlitTransLucent25ZReadWrite(T* data, WORD mask) noexcept
	{
		PaletteData = data;
		Mask = mask;
	}

	virtual ~RLEBlitTransLucent25ZReadWrite() override final = default;
